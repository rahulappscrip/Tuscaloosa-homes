...
export const brookwoodPageSchema = [
  {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How fast can I sell my house for cash in Brookwood, AL?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "You can sell in a short timeframe once you accept a cash home buyer's offer. With a local cash home buyer, there is no waiting on bank financing, repairs, or multiple showings, so closing can usually be scheduled as soon as the title work is ready. If you need more time, you can often choose a later closing date that fits your Brookwood move.",
        },
      },
      {
        "@type": "Question",
        name: "Do I need to make repairs before selling my Brookwood house as-is?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. You do not need to make repairs to sell your Brookwood house as-is to a cash home buyer. They purchase in many conditions and they handle repairs after closing, which can save you time, stress, and upfront money compared with fixing to list.",
        },
      },
      {
        "@type": "Question",
        name: "How can a cash buyer determine a fair offer for my Brookwood home?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "A fair cash offer is based on clear math: after-repair value using recent Tuscaloosa County sales, subtract repair costs, then subtract reasonable expenses and profit. Ask each buyer to walk you through these numbers, compare offers, and avoid buyers who add hidden fees or pressure you to sign immediately.",
        },
      },
      {
        "@type": "Question",
        name: "Can foreclosure be avoided by selling to a cash buyer?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. A fast cash sale can sometimes help you avoid foreclosure if it closes before the auction date. By working with a Tuscaloosa County cash home buyer you can pay off the loan faster, but timing is critical and this is not legal advice.",
        },
      },
      {
        "@type": "Question",
        name: "What are the advantages of selling as-is compared with fixing up and listing?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Selling as-is trades a higher potential price for speed and less hassle. When you sell as-is to a cash home buyer, you skip repairs, showings, and contractor headaches, but the price is usually lower. Fixing your house first and listing it can net more but takes time, money, and energy.",
        },
      },
      {
        "@type": "Question",
        name: "Are there any fees or commissions when selling to a cash buyer?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. A true cash home buyer does not charge commissions or surprise fees. In a typical Brookwood cash sale, the buyer covers normal closing costs, and you receive the agreed price at closing minus your mortgage or liens.",
        },
      },
      {
        "@type": "Question",
        name: "Do cash buyers buy houses in Brookwood and nearby areas?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. Cash home buyers often purchase Brookwood and Tuscaloosa County houses in many conditions, including outdated or damaged homes. They factor repairs into the offer and handle the work after closing, so you can sell without fixing everything first.",
        },
      },
      {
        "@type": "Question",
        name: "Can I sell an inherited Brookwood house if it still needs to go through probate?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "In many cases you can start selling an inherited Brookwood house during or after probate, with the right approvals. A Tuscaloosa County cash home buyer can coordinate with your attorney, but you should rely on legal advice for final decisions.",
        },
      },
      {
        "@type": "Question",
        name: "Do you buy rental properties with tenants in place in Brookwood?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. Many cash home buyers will purchase Brookwood rentals with tenants still in place, including difficult situations. They take over the lease or handle notices after closing, so you can sell without waiting for the property to be vacant.",
        },
      },
      {
        "@type": "Question",
        name: "What information do I need to give to get a cash offer on my Brookwood house?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "You only need a few basics to get a cash offer: your Brookwood property address, beds and baths, general condition, major issues, and your ideal timeline. You usually do not need full disclosures or photos just to start the conversation.",
        },
      },
      {
        "@type": "Question",
        name: "Do you buy houses in Brookwood or all of Tuscaloosa County?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most cash home buyers who focus on Brookwood also buy throughout Tuscaloosa County. If you have a house in Brookwood, Tuscaloosa, Vance, Cottondale, Northport, or a nearby small community, you can usually still request a cash offer. Even if your town is not listed, it is worth asking if they will make an offer.",
        },
      },
    ],
  },
